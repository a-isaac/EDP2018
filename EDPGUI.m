...
%      singleton*.
%
%      H = EDPGUI returns the handle to a new EDPGUI or the handle to
%      the existing singleton*.
%
%      EDPGUI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in EDPGUI.M with the given input arguments.
%
%      EDPGUI('Property','Value',...) creates a new EDPGUI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before EDPGUI_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to EDPGUI_OpeningFcn via varargin.
%
...
% Last Modified by GUIDE v2.5 28-Mar-2018 17:13:57

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @EDPGUI_OpeningFcn, ...
                   'gui_OutputFcn',  @EDPGUI_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before EDPGUI is made visible.
function EDPGUI_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = EDPGUI_OutputFcn(hObject, eventdata, handles) 
